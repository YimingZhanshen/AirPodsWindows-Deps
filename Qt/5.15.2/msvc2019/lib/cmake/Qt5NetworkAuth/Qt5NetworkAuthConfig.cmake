...
if (NOT TARGET Qt5::NetworkAuth)
    ...
    set(Qt5NetworkAuth_PRIVATE_INCLUDE_DIRS
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.15.2"
        "${_qt5NetworkAuth_install_prefix}/include/QtNetworkAuth/5.15.2/QtNetworkAuth"
    )
    ...
    _populate_NetworkAuth_target_properties(RELEASE "Qt5NetworkAuth.dll" "Qt5NetworkAuth.lib" TRUE)



    _populate_NetworkAuth_target_properties(DEBUG "Qt5NetworkAuthd.dll" "Qt5NetworkAuthd.lib" TRUE)
